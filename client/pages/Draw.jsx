        ...
        <div class='content'>
            <section class='hero is-small is-primary'>
                <div class='hero-body container'>
                    ...
                    <button disabled={!acc.premium} class='button is-inline-block' onClick={() => ctxRef.current.strokeStyle = 'black'}>Draw in Black</button>
                    <button disabled={!acc.premium} class='button is-inline-block' onClick={() => ctxRef.current.strokeStyle = 'blue'}>Draw in Blue</button>
